  ...
  render() {
    return (
      <form className="login">
        ...
        <input type="radio" name="ai" value="ai" id="ai" style={{width: "20%"}} onChange={this.handleChange} /><label htmlFor="ai" >AI</label>
        <input type="radio" name="human" value="human" id="human" style={{width: "20%"}} onChange={this.handleChange} /><label htmlFor="human" >Human</label>
